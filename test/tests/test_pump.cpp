...
void test_pump_pct_for_pressure(void) {
  ...
  TEST_ASSERT_EQUAL_FLOAT_ACCURACY(pctFor2Mls, getPumpPct(6.f, 2.f, testState), 0);
  ...
  TEST_ASSERT_EQUAL_FLOAT_ACCURACY(0, getPumpPct(6.f, 0.f, testState), 0);
  ...
  TEST_ASSERT_EQUAL_FLOAT_ACCURACY(1, getPumpPct(3.f, 0.f, testState), 0);
